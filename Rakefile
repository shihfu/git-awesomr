...
task "db:populate" do
  ...
  Achievement.create(name: "Forks", level: 1 , url: "/images/outline_motherboard.png", criteria: 1)
  Achievement.create(name: "Forks", level: 2 , url: "/images/solid_motherboard.png", criteria: 3)
  Achievement.create(name: "Forks", level: 3 , url: "/images/flat_motherboard.png", criteria: 5)
  ...
  Achievement.create(name: "Commits", level: 2 , url: "/images/solid_seat_belt.png", criteria: 100)
